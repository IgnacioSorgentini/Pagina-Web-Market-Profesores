    ...
    return(
        <div className="PantallaPrincipal">
            <div style={{minWidth:"60%", display:"flex", flexDirection:"column", padding:"20px", boxSizing:"border-box", }}>
                <div style={{maxWidth:"80%", minHeight:"100%", display:"flex", flexDirection:"column", borderRadius:"10px"}} className="fondoGradiente">
                    <div style={{minHeight:"20%", minWidth:"100%", boxSizing:"border-box", display:"flex", justifyContent:"center", alignItems:"center", marginLeft:"15px"}}>
                    ...
                    <div style={{marginTop: "-630px", minHeight:"80%", minWidth:"100%", boxSizing:"border-box", display:"flex", flexDirection:"column", justifyContent:"end", alignItems:"center"}}>
                        <div style={{minWidth:"60%", boxSizing:"border-box", display:"flex", justifyContent:"center"}}>
                            <Link to="/inicioSesion" style={{textDecoration:"none"}}><Button variant="outlined" size="large" style={{margin:"20px", color:"white", borderColor:"white", background:"#3D56B2"}} disableElevation>Iniciar sesion</Button></Link>
                        </div>
                        <div style={{minWidth:"60%", boxSizing:"border-box", display:"flex", justifyContent:"center"}}>
                            <Link to="/registro" style={{textDecoration:"none"}}><Button variant="outlined" size="large" style={{margin:"20px", color:"white", borderColor:"white", background:"#3D56B2"}}>Registrarse</Button></Link>
                        </div>
                    </div>
                </div>
            </div>
